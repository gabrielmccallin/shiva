...
describe("typed container", () => {
  ...
  it("should return a custom element", () => {
    const wrapper = container({ customElement: "hello" });
  ...
  it("should return a div with attributes", () => {
    ...
    Object.entries(fixture).forEach(([key, value]) => {
      expect(wrapper.getAttribute(key)).toEqual(value);
    });
  });
  ...
  it("should return a container with textContent", () => {
    ...
    expect(wrapper.textContent).toEqual(fixture);
  });
  ...
  it("should add style", () => {
    ...
    expect(wrapper.style.color).toEqual("green");
  });
  ...
  it("create container with child", () => {
    const children = container({ textContent: "1" });
  ...
  it("create container with HTMLElement children and textNodes", () => {
    const testContainer = container({
      children: ["Hello", container({ textContent: "2" })],
    });
  ...
  it("update container with new properties", () => {
    ...
    expect(element.style.color).toEqual(config.style.color);
  });
});
