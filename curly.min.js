var curly;!function(t){var e=function(){function t(t,e,i){this._type=t,this._target=e,this.data=i}return t.prototype.getTarget=function(){return this._target},t.prototype.getType=function(){return this._type},t.prototype.getData=function(){return this.data},t}();t.Event=e;var i=function(){function t(){this._listeners=[]}return t.prototype.hasEventListener=function(t,e){for(var i=!1,n=0;n<this._listeners.length;n++)this._listeners[n].type===t&&this._listeners[n].listener===e&&(i=!0);return i},t.prototype.addEventListener=function(t,e,i){this.hasEventListener(e,i)||this._listeners.push({scope:t,type:e,listener:i})},t.prototype.removeEventListener=function(t,e){for(var i=0;i<this._listeners.length;i++)this._listeners[i].type===t&&this._listeners[i].listener===e&&this._listeners.splice(i,1)},t.prototype.dispatchEvent=function(t){for(var e=0;e<this._listeners.length;e++)this._listeners[e].type===t.getType()&&this._listeners[e].listener.call(this._listeners[e].scope,t)},t}();t.EventDispatcher=i}(curly||(curly={}));var curly;!function(t){var e=function(){function t(){}return t.set=function(t,e){var i;i=t.element?t.element:t;for(var n in e){var r=e[n];if("number"==typeof r&&r)switch(n){case"x":r=e[n].toString(),r+="px";break;case"y":r=e[n].toString(),r+="px";break;case"height":r=e[n].toString(),r+="px";break;case"width":r=e[n].toString(),r+="px";break;case"backgroundColor":var o=e[n]>>16,s=e[n]>>8&255,h=255&e[n];r="rgb("+o+","+s+","+h+")";break;case"color":var o=e[n]>>16,s=e[n]>>8&255,h=255&e[n];r="rgb("+o+","+s+","+h+")"}var l=n;switch(n){case"x":l="left";break;case"y":l="top";break;case"alpha":l="opacity"}i.style[l]=r}},t}();t.Properties=e}(curly||(curly={}));var __extends=this.__extends||function(t,e){function i(){this.constructor=t}for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n]);i.prototype=e.prototype,t.prototype=new i},curly;!function(t){var e=function(e){function i(t,i){e.call(this),i?"boolean"==typeof i?(this.element=document.createElement("div"),document.body.appendChild(this.element)):this.element=document.createElement(i):this.element=document.createElement("div"),this.element.id=t,this.set({position:"absolute",top:"0px",left:"0px",width:"100%",height:"100%",display:"block"})}return __extends(i,e),i.prototype.measure=function(){if(document.body.contains(this.element))this.calculatedWidth||(this.calculatedWidth=this.element.offsetWidth),this.calculatedHeight||(this.calculatedHeight=this.element.offsetHeight);else{var t=this.element.parentElement;document.body.appendChild(this.element),this.calculatedWidth=this.element.offsetWidth,this.calculatedHeight=this.element.offsetHeight,t?t.appendChild(this.element):document.body.removeChild(this.element)}},i.prototype.addToBody=function(){document.body.appendChild(this.element)},i.prototype.set=function(e){t.Properties.set(this.element,e)},i.prototype.addChild=function(t){var e;e=t.element?t.element:t,this.element.appendChild(e)},i.prototype.removeChild=function(t){this.element===t.element.parentNode&&this.element.removeChild(t.element)},i.prototype.to=function(t,e){TweenMax.to(this.element,t,e)},i.prototype.fromTo=function(t,e,i){TweenMax.fromTo(this.element,t,e,i)},i.prototype.addDomEventListener=function(t,e,i){var n=t?function(e){i.apply(t,[e])}:i;this._listeners.push({scope:t,type:e,listener:i,scopedEventHandler:n}),this.element.addEventListener?this.element.addEventListener(e,n,!1):this.element.attachEvent&&(this.element.attachEvent("on"+e,n),this.element.attachEvent("onpropertychange",function(t){t.eventType==e&&(t.cancelBubble=!0,t.returnValue=!1,t.data=t.customData,n(t))}))},i.prototype.removeDomEventListener=function(t,e){for(var i=0;i<this._listeners.length;i++)if(this._listeners[i].type===t&&this._listeners[i].listener===e)return this.element.removeEventListener?(this.element.removeEventListener(t,this._listeners[i].scopedEventHandler,!1),!0):this.element.detachEvent?this.element.detachEvent("on"+t,e):!1},i.prototype.preventDefault=function(t){t.preventDefault?t.preventDefault():t.returnValue=!1},Object.defineProperty(i.prototype,"width",{get:function(){return this.measure(),this.calculatedWidth},set:function(e){t.Properties.set(this.element,{width:e}),this.calculatedWidth=this.element.offsetWidth},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"height",{get:function(){return this.measure(),this.calculatedHeight},set:function(e){t.Properties.set(this.element,{height:e}),this.calculatedHeight=this.element.offsetHeight},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"y",{get:function(){return this.element.offsetTop},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"x",{get:function(){return this.element.offsetLeft},enumerable:!0,configurable:!0}),i}(t.EventDispatcher);t.Container=e}(curly||(curly={}));var curly;!function(t){var e=function(){function t(){}return t}();t.ButtonVars=e}(curly||(curly={}));var curly;!function(t){var e=function(e){function i(i){if(i.id?(e.call(this,i.id),this.identifier=i.id):(e.call(this,"Button"),this.identifier="Button"),this.enabled=!0,void 0===i.target&&(i.target="_self"),this.addDomEventListener(this,"mouseover",this.overWithEnable),this.addDomEventListener(this,"mouseout",this.outWithEnable),this.addDomEventListener(this,"click",this.click),i.href){var n=new t.Container("link","a"),r=n.element;r.href=i.href,r.target=i.target,n.set({width:i.width,height:i.height,backgroundColor:0,alpha:0}),this.addChild(n)}this.set({width:i.width,height:i.height,cursor:"pointer"})}return __extends(i,e),i.prototype.init=function(){},i.prototype.overWithEnable=function(t){this.enabled&&this.over()},i.prototype.outWithEnable=function(t){this.enabled&&this.out()},i.prototype.over=function(){},i.prototype.out=function(){},i.prototype.click=function(){if(this.enabled){var e=new t.Event(i.CLICK,this);this.dispatchEvent(e)}},i.prototype.disable=function(){this.enabled=!1,this.set({cursor:"default"})},i.prototype.select=function(){this.enabled=!1,this.set({cursor:"default"})},i.prototype.enable=function(){this.enabled=!0,this.set({cursor:"pointer"})},i.prototype.setId=function(t){this.identifier=t},i.CLICK="CLICK",i}(t.Container);t.Button=e}(curly||(curly={}));var curly;!function(t){var e=function(t){function e(e){e?t.call(this,e,"img"):t.call(this,"Image","img"),this.set({width:"auto",height:"auto"}),this.addDomEventListener(this,"load",this.loaded),this.addDomEventListener(this,"error",this.error)}return __extends(e,t),e.prototype.loaded=function(t){console.log("picture loaded: ",t)},e.prototype.error=function(t){console.log("error")},e.prototype.load=function(t){this.element.setAttribute("src",t)},e}(t.Container);t.Image=e}(curly||(curly={}));var curly;!function(t){var e=function(){function t(){this.text="Text"}return t}();t.TextFieldVars=e}(curly||(curly={}));var curly;!function(t){var e=function(t){function e(e){e.id?t.call(this,e.id):t.call(this,"TextField"),""==e.fontSize&&(e.fontSize="1em");var i;i=e.width?e.width:"auto";var n;n=e.height?e.height:"auto",this.set({width:i,height:n,top:0,left:0,overflow:"hidden",msUserSelect:"text"}),this.set(e),this.setText(e.text)}return __extends(e,t),e.prototype.setText=function(t){this.element.innerHTML=t},e.prototype.addText=function(t){t=this.element.innerHTML+t,this.element.innerHTML=t+"<br/>"},e.prototype.addBorder=function(t,e,i){null==t&&(t=1),null==e&&(e="solid"),null==i&&(i=0),this.element.style.border=t+"px",this.element.style.borderStyle=e,this.element.style.borderColor=String(i)},e}(t.Container);t.TextField=e}(curly||(curly={}));var curly;!function(t){var e=function(t){function e(e,i,n,r){r?t.call(this,r):t.call(this,"Rectangle"),this.set({width:e,height:i,backgroundColor:n,top:0,left:0,overflow:"hidden"})}return __extends(e,t),e.prototype.addBorder=function(t,e,i){"undefined"==typeof t&&(t=1),"undefined"==typeof e&&(e="solid"),"undefined"==typeof i&&(i="#000000"),this.set({border:t+"px",borderStyle:e,borderColor:String(i)})},e}(t.Container);t.Rectangle=e}(curly||(curly={}));var curly;!function(t){var e=function(){function t(){this.text="Button",this.bgColourOut="#dddddd",this.bgColourOver="#5555dd",this.margin=10}return t}();t.LabelButtonVars=e}(curly||(curly={}));var curly;!function(t){var e=function(e){function i(i){i||(i=new t.LabelButtonVars),!i.id&&i.text&&(i.id=i.text),e.call(this,i),this.vars=i;var n=new t.TextFieldVars;for(var r in this.vars)n[r]=this.vars[r];this.vars.width&&(n.width=this.vars.width-2*this.vars.margin),n.color=this.vars.fontColourOut,n.height="auto",this.field=new t.TextField(n),this.field.set({letterSpacing:this.vars.letterSpacing,whiteSpace:"nowrap"}),this.addChild(this.field),this.btnWidth=this.vars.width?this.vars.width:this.field.width+2*this.vars.margin,this.btnHeight=this.vars.height?this.vars.height:this.field.height+2*this.vars.margin,this.bg=new t.Rectangle(this.btnWidth,this.btnHeight,this.vars.bgColourOut,"buttonBg"),this.vars.cornerRadius&&this.bg.set({borderRadius:this.vars.cornerRadius}),this.vars.border&&this.bg.addBorder(this.vars.borderThickness,this.vars.border,this.vars.borderColour),this.addChild(this.bg),this.addChild(this.field);var o=this.btnHeight/2-this.field.height/2;this.field.set({x:this.vars.margin,y:o}),this.set({width:this.btnWidth,height:this.btnHeight,cursor:"pointer"})}return __extends(i,e),i.prototype.init=function(){},i.prototype.over=function(){this.field.to(.1,{color:this.vars.fontColourOver}),this.bg.to(.1,{backgroundColor:this.vars.bgColourOver})},i.prototype.out=function(){this.field.to(1,{color:this.vars.fontColourOut}),this.selected&&this.vars.bgSelectedColour?this.bg.to(1,{backgroundColor:this.vars.bgSelectedColour}):this.bg.to(1,{backgroundColor:this.vars.bgColourOut})},i.prototype.update=function(t){this.field.setText(t),e.prototype.setId.call(this,t)},i.prototype.disable=function(){e.prototype.disable.call(this),TweenMax.to(this.field.element,1,{alpha:.2}),TweenMax.to(this.bg.element,1,{alpha:.2})},i.prototype.select=function(){e.prototype.select.call(this),this.selected=!0,TweenMax.to(this.field.element,.5,{color:this.vars.fontColourOver,alpha:1}),this.vars.bgSelectedColour&&TweenMax.to(this.bg.element,.5,{backgroundColor:this.vars.bgSelectedColour,alpha:1})},i.prototype.enable=function(){e.prototype.enable.call(this),this.selected=!1,TweenMax.to(this.field.element,1,{color:this.vars.fontColourOut,alpha:1}),TweenMax.to(this.bg.element,1,{backgroundColor:this.vars.bgColourOut,alpha:1})},Object.defineProperty(i.prototype,"height",{get:function(){return this.btnHeight},set:function(t){this.field.height=t,this.bg.height=t},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"width",{get:function(){return this.btnWidth},set:function(t){this.field.width=t,this.bg.width=t},enumerable:!0,configurable:!0}),i}(t.Button);t.LabelButton=e}(curly||(curly={}));var curly;!function(t){var e=function(){function t(){}return t.addEventListener=function(t,e,i){this.observers[e]||(this.observers[e]=[]),console.log("ADDING OBSERVER: ",e),this.observers[e].push({scope:t,type:e,callback:i})},t.removeEventListener=function(t,e){for(var i,n=0;n<this.observers[t].length;n++)if(this.observers[t].callback===e){i=n,console.log("REMOVING OBSERVER: ",t);break}this.observers[t].splice(i,1)},t.dispatchEvent=function(t){var e=t.getType();if(this.observers[e])for(var i=0;i<this.observers[e].length;i++)this.observers[e][i].callback.call(this.observers[e][i].scope,t);else console.log("DISPATCH ERROR: NO OBSERVER REGISTERED")},t.observers={},t}();t.Observer=e}(curly||(curly={}));var curly;!function(t){var e=function(){function t(){}return t.proportionalOutside=function(t,e,i,n){var r=t/e,o=i,s=i*r;return n>s&&(s=n,o=s*r),{height:s,width:o}},t.proportionalInside=function(t,e,i,n){var r=t/e,o=i,s=i*r;return s>n&&(s=n,o=s*r),{height:s,width:o}},t}();t.Resize=e}(curly||(curly={}));var curly;!function(t){var e=function(e){function i(){e.call(this)}return __extends(i,e),i.prototype.load=function(t,e,i,n,r,o){this.http?this.http.abort():this.http=new XMLHttpRequest,this.http.open(e,t,!0),this.http.timeout=2e4;for(var s in r)this.http.setRequestHeader(r[s].value,r[s].variable);this.http.onreadystatechange=this.handleResponse.bind(this),this.http.send(i)},i.prototype.setRequestHeader=function(t){this.http.setRequestHeader(t.value,t.variable)},i.prototype.post=function(t,e,i,n){"undefined"==typeof n&&(n=!1),this.http&&this.http.abort(),this.http=new XMLHttpRequest,this.http.open("POST",t,!0),console.log("LOADING",t),this.http.timeout=2e4,this.http.setRequestHeader("Content-type","application/json"),this.http.onreadystatechange=this.handleResponse.bind(this),this.http.send(e)},i.prototype.handleResponse=function(){if(4==this.http.readyState)if(200==this.http.status){var n=new t.Event(i.COMPLETE,this,this.http.responseText);e.prototype.dispatchEvent.call(this,n),this.http.onreadystatechange=null}else{var r;r=0===this.http.status?"Network Error 0x2ee2":this.http.status.toString();var n=new t.Event(i.ERROR,this,this.http.status);e.prototype.dispatchEvent.call(this,n)}},i.COMPLETE="COMPLETE",i.ERROR="ERROR",i.GET="GET",i.PUT="PUT",i.POST="POST",i.UPDATE="UPDATE",i}(t.EventDispatcher);t.URLLoader=e}(curly||(curly={}));var curly;!function(t){var e=function(){function t(){}return t.scrollY=function(){var t=document.body.scrollTop;return 0==t&&(t=window.pageYOffset?window.pageYOffset:document.body.parentElement?document.body.parentElement.scrollTop:0),t},t.scrollX=function(){var t=document.body.scrollLeft;return 0==t&&(t=window.pageXOffset?window.pageXOffset:document.body.parentElement?document.body.parentElement.scrollLeft:0),t},Object.defineProperty(t,"height",{get:function(){return window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight},enumerable:!0,configurable:!0}),Object.defineProperty(t,"width",{get:function(){return window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth},enumerable:!0,configurable:!0}),t}();t.Window=e}(curly||(curly={}));
